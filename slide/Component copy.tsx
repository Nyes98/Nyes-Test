...
const MainCarouselComponent: React.FC<Props> = ({
    ...
    return (
        <TestComp>
            <CarouselImgBox move={move} next={next} prev={prev} test={test} className={test ? '' : 'test1'}>
...
const CarouselBtnBox = styled.div`
    ...
    img {
        cursor: pointer;
        width: 50px;
        filter: invert(38%) sepia(7%) saturate(358%) hue-rotate(202deg) brightness(94%) contrast(95%);
    }
`;
